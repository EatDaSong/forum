            ...
            <div id="wrapper">
                <div id="login" class="animate form">
                    <form  action="?page=connect" autocomplete="on" method="post"> 
                        ...
                        <p> 
                            ...
                            ?>
                            <label for="username" class="uname" data-icon="u" > Ton identifiant de connexion ou ton email </label>
                            <input id="username" name="username" required="required" type="text" placeholder="monidentifiant ou monemail@email.com"/>
                        </p>
                        <p> 
                            <label for="password" class="youpasswd" data-icon="p"> Ton mot de passe </label>
                ...
                <div id="register" class="animate form">
                    <form  action="?page=inscription" autocomplete="on" method="post"> 
                        <h1> Sign up </h1> 
                        <p> 
                            <label for="usernamesignup" class="uname" data-icon="u">Ton identifiant de connexion</label>
                        ...
                        <p> 
                            <label for="usernamesignup" class="uname" data-icon="u">Ton pseudo affiché sur le forum</label>
                        ...
                        <p> 
                            <label for="emailsignup" class="youmail" data-icon="e" > Ton email</label>
                        ...
                        <p> 
                            <label for="passwordsignup" class="youpasswd" data-icon="p">Ton mot de passe </label>
                            <?php if(isset($_GET['erreurPass'])) { ?><label for="passwordsignup" class="youpasswd" data-icon="p"><font color="red">Tes mots de passes ne correspondent pas. </font></label><?php } ?> <!-- Affichage erreur password -->
                            <input id="passwordsignup" name="password" required="required" type="password" placeholder="X8df!90EO"/>
                        </p>
                        <p> 
                            <label for="passwordsignup_confirm" class="youpasswd" data-icon="p">Merci de confirmer ton mot de passe</label>
                            <?php if(isset($_GET['erreurPass'])) { ?><label for="passwordsignup" class="youpasswd" data-icon="p"><font color="red">Tes mots de passes ne correspondent pas. </font></label><?php } ?> <!-- Affichage erreur password -->
