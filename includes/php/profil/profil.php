<div class="profil">
    <center>
        <form method="post" action="?page=profil&profil=editProfil">
            ...
            <div id="profilChangePseudo" style="display: none;"><p><input type="text" name="pseudo" value="<?php echo $_SESSION['pseudo']; ?>"/></p></div>
            ...
            <div id="profilChangeUsername" style="display: none;"><p><input type="text" name="username" value="<?php echo $_SESSION['username']; ?>"/></p></div>
            ...
            <div id="profilChangeEmail" style="display: none;"><p><input type="text" name="email" value="<?php echo $_SESSION['email']; ?>"/></p></div>
            ...
            <div id="profilChangeSignature" style="display: none;"><p><textarea name="signature" rows="5" cols="40"><?php if(empty($_SESSION['signature'])) { echo "Vous n'avez pas encore de signature"; } else { echo $_SESSION['signature']; } ?></textarea></p></div>
